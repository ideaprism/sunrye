...
test("public summary pages route repeated bundled images through thumbnails", () => {
  ...
  assert.match(family, /getGalleryThumbnailSrc\("\/images\/jung-youngsam-autumn-birch\.jpg"\)/)
  assert.doesNotMatch(family, /https:\/\/sjc\.microlink\.io/)
  assert.match(family, /https:\/\/youngsam\.vercel\.app\//)
  assert.doesNotMatch(family, /v0-artist-website-design-beige\.vercel\.app/)
})
