  ...
  return (
    <div className="min-h-screen bg-floralwhite pt-16">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-16 grid items-start gap-8 md:grid-cols-[minmax(0,1fr)_minmax(220px,300px)] lg:grid-cols-[minmax(0,1fr)_minmax(220px,340px)] lg:gap-12">
          ...
          <div className="relative mx-auto aspect-[9/16] w-full max-w-[280px] overflow-hidden rounded-lg bg-rose-50 shadow-2xl md:mx-0 lg:max-w-[340px]">
            <Image
